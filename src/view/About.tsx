    ...
    return (
        <div className={'flex flex-col '}>
            ...
            <div className="bg-white flex h-screen pb-20">
                <div className={'mr-6 w-1/6 bg-white shadow-2xl my-10 border border-gray-200 rounded-tr-[60px] rounded-br-[60px]'}></div>
                <div className={'w-5/6 bg-gray-500 '}></div>
            </div>
            <div className="bg-white flex flex-col items-stretch">
                <div
                    className="bg-white flex w-full flex-col items-center pt-12 pb-8 px-16 max-md:max-w-full max-md:px-5">
                    <div className="w-full max-w-[1144px] mt-3.5 max-md:max-w-full">
                        <div className="gap-5 flex max-md:flex-col max-md:items-stretch max-md:gap-0">
                            ...
                            <div
                                className="text-[18px] flex flex-col items-stretch w-[40%] ml-5 max-md:w-full max-md:ml-0 bg-green-50 rounded-2xl pt-6 pl-13">
